...
# 全局变量
SCRIPT_VERSION="0.6.4-tinacious-light-palette"
...
# 颜色定义：参考 Ghostty "Tinacious Design (Light)" 浅色主题。
# 原则：保留粉紫青的鲜明个性，同时压低亮度以适配浅色背景。
init_terminal_colors() {
    if [ -t 1 ] && [ -z "${NO_COLOR:-}" ] && [ "${TERM:-}" != "dumb" ]; then
        COLOR_RESET='\033[0m'
        COLOR_BOLD='\033[1m'
        COLOR_SUCCESS='\033[1;38;5;35m'   # Tinacious 绿：成功/完成
        COLOR_WARN='\033[1;38;5;172m'     # 金橙：警告
        COLOR_ERROR='\033[1;38;5;161m'    # 洋红红：错误/root
        COLOR_INFO='\033[1;38;5;32m'      # 鲜蓝：常规信息
        COLOR_DEBUG='\033[38;5;30m'       # 深青：调试/次要信息
        COLOR_ACCENT='\033[1;38;5;92m'    # 紫色：强调/横幅
        COLOR_SECTION='\033[1;38;5;31m'   # 蓝青：段落标题
        COLOR_MUTED='\033[38;5;240m'      # 石墨灰：弱化文本
    else
        COLOR_RESET=''
        COLOR_BOLD=''
        COLOR_SUCCESS=''
...
init_terminal_colors() {
    if [ -t 1 ] && [ -z "${NO_COLOR:-}" ] && [ "${TERM:-}" != "dumb" ]; then
        COLOR_RESET='\033[0m'
        COLOR_SUCCESS='\033[1;38;5;35m'
        COLOR_WARN='\033[1;38;5;172m'
        COLOR_ERROR='\033[1;38;5;161m'
        COLOR_INFO='\033[1;38;5;32m'
        COLOR_DEBUG='\033[38;5;30m'
        COLOR_ACCENT='\033[1;38;5;92m'
        COLOR_SECTION='\033[1;38;5;31m'
    else
        COLOR_RESET=''
        COLOR_SUCCESS=''
        COLOR_WARN=''
...
if [ ! -f "$HOME/.oh-my-zsh/oh-my-zsh.sh" ]; then
    if [ -d "$HOME/.oh-my-zsh" ]; then
        backup_dir="$HOME/.oh-my-zsh.incomplete.$(date +%Y%m%d_%H%M%S)"
        echo -e "${YELLOW}[WARN]${NC} 检测到不完整的 Oh My Zsh 目录，备份到 $backup_dir"
...
# Ghostty Tinacious Design (Light) 色彩管理：鲜明粉紫青，适配浅色背景。
export TERM1984_INK="#1d1d26"
export TERM1984_BLUE="#0078d7"
export TERM1984_TEAL="#008f95"
export TERM1984_CYAN="#009a9a"
export TERM1984_GREEN="#008f5a"
export TERM1984_OLIVE="#6f7300"
export TERM1984_AMBER="#b88700"
export TERM1984_ORANGE="#c05a00"
export TERM1984_RED="#c2185b"
export TERM1984_ROSE="#d12b7f"
export TERM1984_VIOLET="#6f42c1"
export TERM1984_PLUM="#8a2be2"
export TERM1984_MUTED="#606070"
export TERM1984_SELECT="#eadff7"
export TERM1984_SELECT_SOFT="#ddeff2"
export TERM1984_XTERM_INFO=32
export TERM1984_XTERM_SECTION=31
export TERM1984_XTERM_LINK=30
export TERM1984_XTERM_SUCCESS=35
export TERM1984_XTERM_OLIVE=58
export TERM1984_XTERM_WARN=172
export TERM1984_XTERM_ERROR=161
export TERM1984_XTERM_ROSE=162
export TERM1984_XTERM_ACCENT=92
export TERM1984_XTERM_VIOLET=99
export TERM1984_XTERM_MUTED=240

export LS_COLORS="di=1;38;5;${TERM1984_XTERM_INFO}:ln=38;5;${TERM1984_XTERM_LINK}:so=38;5;${TERM1984_XTERM_VIOLET}:pi=38;5;${TERM1984_XTERM_OLIVE}:ex=1;38;5;${TERM1984_XTERM_SUCCESS}:bd=38;5;${TERM1984_XTERM_ERROR}:cd=38;5;${TERM1984_XTERM_ERROR}:su=1;38;5;${TERM1984_XTERM_ERROR}:sg=1;38;5;${TERM1984_XTERM_ACCENT}:tw=1;38;5;${TERM1984_XTERM_WARN}:ow=1;38;5;${TERM1984_XTERM_INFO}:*.tar=38;5;${TERM1984_XTERM_ERROR}:*.tgz=38;5;${TERM1984_XTERM_ERROR}:*.zip=38;5;${TERM1984_XTERM_ERROR}:*.gz=38;5;${TERM1984_XTERM_ERROR}:*.xz=38;5;${TERM1984_XTERM_ERROR}:*.7z=38;5;${TERM1984_XTERM_ERROR}:*.deb=38;5;${TERM1984_XTERM_ROSE}:*.rpm=38;5;${TERM1984_XTERM_ROSE}:*.jpg=38;5;${TERM1984_XTERM_ACCENT}:*.jpeg=38;5;${TERM1984_XTERM_ACCENT}:*.png=38;5;${TERM1984_XTERM_ACCENT}:*.gif=38;5;${TERM1984_XTERM_ACCENT}:*.webp=38;5;${TERM1984_XTERM_ACCENT}:*.svg=38;5;${TERM1984_XTERM_VIOLET}:*.mp4=38;5;${TERM1984_XTERM_INFO}:*.mkv=38;5;${TERM1984_XTERM_INFO}:*.mov=38;5;${TERM1984_XTERM_INFO}:*.mp3=38;5;${TERM1984_XTERM_SUCCESS}:*.flac=38;5;${TERM1984_XTERM_SUCCESS}:*.wav=38;5;${TERM1984_XTERM_SUCCESS}:*.json=38;5;${TERM1984_XTERM_WARN}:*.yaml=38;5;${TERM1984_XTERM_WARN}:*.yml=38;5;${TERM1984_XTERM_WARN}:*.toml=38;5;${TERM1984_XTERM_WARN}:*.conf=38;5;${TERM1984_XTERM_OLIVE}:*.service=38;5;${TERM1984_XTERM_OLIVE}:*.log=38;5;${TERM1984_XTERM_MUTED}:*.md=38;5;${TERM1984_XTERM_SECTION}:*.sh=1;38;5;${TERM1984_XTERM_SUCCESS}:*.zsh=1;38;5;${TERM1984_XTERM_SUCCESS}"
TERM1984_FZF_COLORS="fg:${TERM1984_INK},hl:${TERM1984_BLUE},fg+:${TERM1984_INK},bg+:${TERM1984_SELECT_SOFT},hl+:${TERM1984_ROSE},info:${TERM1984_ORANGE},prompt:${TERM1984_TEAL},pointer:${TERM1984_RED},marker:${TERM1984_GREEN},spinner:${TERM1984_PLUM},header:${TERM1984_VIOLET},border:${TERM1984_CYAN},gutter:-1"
FZF_TINACIOUS_LIGHT_COLORS="--color=$TERM1984_FZF_COLORS"
if [[ " ${FZF_DEFAULT_OPTS:-} " != *" --color=fg:${TERM1984_INK},hl:${TERM1984_BLUE},"* ]]; then
    export FZF_DEFAULT_OPTS="${FZF_DEFAULT_OPTS:+$FZF_DEFAULT_OPTS }$FZF_TINACIOUS_LIGHT_COLORS"
fi
unset FZF_TINACIOUS_LIGHT_COLORS
ZSH_AUTOSUGGEST_HIGHLIGHT_STYLE="fg=${TERM1984_XTERM_MUTED}"
typeset -A ZSH_HIGHLIGHT_STYLES
ZSH_HIGHLIGHT_STYLES[comment]="fg=${TERM1984_XTERM_MUTED}"
ZSH_HIGHLIGHT_STYLES[command]="fg=${TERM1984_XTERM_INFO},bold"
ZSH_HIGHLIGHT_STYLES[alias]="fg=${TERM1984_XTERM_SUCCESS},bold"
ZSH_HIGHLIGHT_STYLES[builtin]="fg=${TERM1984_XTERM_INFO},bold"
ZSH_HIGHLIGHT_STYLES[function]="fg=${TERM1984_XTERM_SECTION},bold"
ZSH_HIGHLIGHT_STYLES[path]="fg=${TERM1984_XTERM_VIOLET}"
ZSH_HIGHLIGHT_STYLES[globbing]="fg=${TERM1984_XTERM_WARN},bold"
ZSH_HIGHLIGHT_STYLES[single-hyphen-option]="fg=${TERM1984_XTERM_WARN}"
ZSH_HIGHLIGHT_STYLES[double-hyphen-option]="fg=${TERM1984_XTERM_WARN}"
ZSH_HIGHLIGHT_STYLES[unknown-token]="fg=${TERM1984_XTERM_ERROR},bold"
ZSH_HIGHLIGHT_STYLES[reserved-word]="fg=${TERM1984_XTERM_ACCENT},bold"
ZSH_HIGHLIGHT_STYLES[single-quoted-argument]="fg=${TERM1984_XTERM_OLIVE}"
ZSH_HIGHLIGHT_STYLES[double-quoted-argument]="fg=${TERM1984_XTERM_OLIVE}"
ZSH_HIGHLIGHT_STYLES[dollar-quoted-argument]="fg=${TERM1984_XTERM_OLIVE}"
ZSH_HIGHLIGHT_STYLES[dollar-double-quoted-argument]="fg=${TERM1984_XTERM_ROSE}"
ZSH_HIGHLIGHT_STYLES[back-double-quoted-argument]="fg=${TERM1984_XTERM_ROSE}"
ZSH_HIGHLIGHT_STYLES[back-quoted-argument]="fg=${TERM1984_XTERM_ROSE}"
ZSH_HIGHLIGHT_STYLES[commandseparator]="fg=${TERM1984_XTERM_MUTED}"
ZSH_HIGHLIGHT_STYLES[redirection]="fg=${TERM1984_XTERM_LINK},bold"
...
zstyle ':fzf-tab:*' fzf-flags "--color=$TERM1984_FZF_COLORS"
...
[character]
success_symbol = "[❯](bold fg:#008f5a)"
error_symbol = "[❯](bold fg:#c2185b)"
vicmd_symbol = "[❮](bold fg:#b88700)"

[directory]
style = "bold fg:#008f95"
truncation_length = 3
...
[username]
show_always = true
style_root = "bold fg:#c2185b"
style_user = "bold fg:#0078d7"
format = "[$user]($style)"

[hostname]
ssh_only = false
style = "bold fg:#b88700"
format = "[@$hostname]($style)"

[git_branch]
symbol = "🌱 "
style = "bold fg:#8a2be2"
format = " [$symbol$branch]($style)"

[git_status]
style = "bold fg:#d12b7f"
format = '([ \[$all_status$ahead_behind\]]($style))'

[cmd_duration]
min_time = 2000
style = "bold fg:#c05a00"
...
[nodejs]
disabled = false
format = " [🤖 $version](bold fg:#008f5a) "

[python]
disabled = false
format = " [🐍 $version](bold fg:#b88700) "

[golang]
disabled = false
format = " [Go $version](bold fg:#009a9a) "

[rust]
disabled = false
format = " [Rust $version](bold fg:#c05a00) "
EOF
...
cat > "$HOME/.config/fastfetch/config.jsonc" << 'EOF'
{
  ...
  "logo": {
    ...
    "color": {
      "1": "magenta" // Tinacious Light 使用粉紫作为主色，保持鲜明但不刺眼
    },
    "padding": {
  ...
  "modules": [
    ...
    },
    {
      "type": "command",
      "key": "  用 户 名",
      "text": "u=$(whoami); if [ \"$u\" = \"root\" ]; then printf '\\033[1;38;5;161m%s\\033[0m' \"$u\"; else printf '\\033[1;38;5;35m%s\\033[0m' \"$u\"; fi"
    },
    {
      "type": "uptime",
